  ...
  return (
    <div className="relative bg-white" id="features">
      <div className="grid grid-cols-4 gap-8 max-w-[75rem] mx-auto w-full pt-16 pb-24">
        <div>
          <span className="text-[0.8125rem]/5 text-[#6C47FF] font-medium">What&apos;s next</span>
          ...
          <p className="text-[0.8125rem]/5 text-[#5E5F6E]">
            Prebuilt components to handle essential functionality like user sign-in, sign-up, and
            account management.
          </p>
        </div>
        {cards.map((card) => (
          ...
          >
            <div className="px-4 py-3 bg-[#FAFAFB] space-y-1 flex-1">
              <h3 className="text-sm font-medium text-[#131316] tracking-tight">{card.title}</h3>
              <p className="text-[0.8125rem]/5 text-[#5E5F6E]">{card.description}</p>
            </div>
