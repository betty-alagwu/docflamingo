...
import type { Comment, CommentWebhookPayload } from '../interfaces/comment-handler.interface';

export const BOT_USERNAMES = ['revlo-ai', 'revlo-ai[bot]', 'docflamingo-app[bot]', 'docflamingo'];
